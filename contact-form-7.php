...
class Widget_Eael_Contact_Form_7_Stand_Alone extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'EA Contact Form 7', 'elementor-contact-form-7' );
	}
   ...
   public function get_categories() {
		return [ 'elementor-contact-form-7' ];
	}
	...
	protected function _register_controls() {
  		...
  		$this->start_controls_section(
  			...
  			[
  				'label' => esc_html__( 'Contact Form', 'elementor-contact-form-7' )
  			]
  		);
		...
		$this->add_control(
			'eael_wpcf7_form',
			[
				'label' => esc_html__( 'Select your contact form 7', 'elementor-contact-form-7' ),
				'label_block' => true,
				'type' => Controls_Manager::SELECT,
				'options' => eael_select_contact_form_stand_alone(),
			]
		);
        ...
        $this->start_controls_section(
			'eael_section_pro',
			[
				'label' => __( 'Go Premium for More Features', 'elementor-contact-form-7' )
			]
		);
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Unlock more possibilities', 'elementor-contact-form-7' ),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
					'1' => [
						'title' => __( '', 'elementor-contact-form-7' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Form Container Styles', 'elementor-contact-form-7' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Form Background Color', 'elementor-contact-form-7' ),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Form Alignment', 'elementor-contact-form-7' ),
				'type' => Controls_Manager::CHOOSE,
				'label_block' => true,
				'options' => [
					'default' => [
						'title' => __( 'Default', 'elementor-contact-form-7' ),
						'icon' => 'fa fa-ban',
					],
					'left' => [
						'title' => esc_html__( 'Left', 'elementor-contact-form-7' ),
						'icon' => 'fa fa-align-left',
					],
					'center' => [
						'title' => esc_html__( 'Center', 'elementor-contact-form-7' ),
						'icon' => 'fa fa-align-center',
					],
					'right' => [
						'title' => esc_html__( 'Right', 'elementor-contact-form-7' ),
  		...
  		$this->add_responsive_control(
  			...
  			[
  				'label' => esc_html__( 'Form Width', 'elementor-contact-form-7' ),
  		...
  		$this->add_responsive_control(
  			...
  			[
  				'label' => esc_html__( 'Form Max Width', 'elementor-contact-form-7' ),
  				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', '%' ],
				'range' => [
					'px' => [
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Form Margin', 'elementor-contact-form-7' ),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Form Padding', 'elementor-contact-form-7' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', '%' ],
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Border Radius', 'elementor-contact-form-7' ),
				'type' => Controls_Manager::DIMENSIONS,
				'separator' => 'before',
				'size_units' => [ 'px' ],
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Form Fields Styles', 'elementor-contact-form-7' ),
				'tab' => Controls_Manager::TAB_STYLE
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Input Field Background', 'elementor-contact-form-7' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
  		...
  		$this->add_responsive_control(
  			...
  			[
  				'label' => esc_html__( 'Input Width', 'elementor-contact-form-7' ),
  				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', '%' ],
				'range' => [
					'px' => [
  		...
  		$this->add_responsive_control(
  			...
  			[
  				'label' => esc_html__( 'Textarea Width', 'elementor-contact-form-7' ),
  				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', '%' ],
				'range' => [
					'px' => [
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Fields Padding', 'elementor-contact-form-7' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', '%' ],
				'selectors' => [
		...
		$this->add_control(
			...
			[
				...
				'label' => esc_html__( 'Focus State Style', 'elementor-contact-form-7' ),
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Border Color', 'elementor-contact-form-7' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Color & Typography', 'elementor-contact-form-7' ),
				'tab' => Controls_Manager::TAB_STYLE
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Label Color', 'elementor-contact-form-7' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Field Font Color', 'elementor-contact-form-7' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Placeholder Font Color', 'elementor-contact-form-7' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => esc_html__( 'Label Typography', 'elementor-contact-form-7' ),
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => esc_html__( 'Input Fields Typography', 'elementor-contact-form-7' ),
				'separator' => 'before',
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Submit Button Styles', 'elementor-contact-form-7' ),
				'tab' => Controls_Manager::TAB_STYLE
			]
		);
  		...
  		$this->add_responsive_control(
  			...
  			[
  				'label' => esc_html__( 'Button Width', 'elementor-contact-form-7' ),
  				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', '%' ],
				'range' => [
					'px' => [
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Button Alignment', 'elementor-contact-form-7' ),
				'type' => Controls_Manager::CHOOSE,
				'label_block' => true,
				'options' => [
					'default' => [
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Margin', 'elementor-contact-form-7' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', '%' ],
				'selectors' => [
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Padding', 'elementor-contact-form-7' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', '%' ],
				'selectors' => [
		...
		$this->start_controls_tab( 'normal', [ 'label' => esc_html__( 'Normal', 'elementor-contact-form-7' ) ] );

		$this->add_control(
			'eael_contact_form_submit_btn_text_color',
			[
				'label' => esc_html__( 'Text Color', 'elementor-contact-form-7' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Background Color', 'elementor-contact-form-7' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->start_controls_tab( 'eael_contact_form_submit_btn_hover', [ 'label' => esc_html__( 'Hover', 'elementor-contact-form-7' ) ] );
...
Plugin::instance()->widgets_manager->register_widget_type( new Widget_Eael_Contact_Form_7_Stand_Alone() );